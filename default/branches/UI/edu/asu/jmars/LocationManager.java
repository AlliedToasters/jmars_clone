	...
	public Point2D reprojectFromText(String rawText)
	{
	 ...
	 private class PlaceButton extends JButton {
		 ...
		 private PlaceButton(int mode){
			 super();
			 if(mode == BACK){
				 ImageIcon backIcon = new ImageIcon(ImageFactory.createImage(LEFT_ARROW_IMG
						              .withDisplayColor(imgColor))
			 			              .getScaledInstance(16, 18, Image.SCALE_SMOOTH));
				 setIcon(backIcon);
				 ...
				 ImageIcon fwdIcon = new ImageIcon(ImageFactory.createImage(RIGHT_ARROW_IMG
 		   				             .withDisplayColor(imgColor))
						             .getScaledInstance(16, 18, Image.SCALE_SMOOTH));
				 setIcon(fwdIcon);
				 addActionListener(new ActionListener(){

...
//  default		
	...
	public void highlightName(){
		Color foregroundhi = parse(((ThemeCheckBox)GUITheme.get("checkbox")).getForegroundhilight());
		Color foreground = parse(((ThemeCheckBox)GUITheme.get("checkbox")).getForeground());
		for(int i=0; i<sParent.sources.size(); i++){

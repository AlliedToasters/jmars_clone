...
//          log.aprintln(e);
    ...
    public static void updateHeaderValuesAndStartProcessing(CustomMap selectedFile) {
        ...
        request.addRequestParameter("min_lon",selectedFile.getWestLon());
        request.addRequestParameter("max_lon",selectedFile.getEastLon());
        ...
        String cpChanged = "0";
        if (selectedFile.getSelectedUploadProcess() == UploadFile.PROCESSING_OPTION_MANUAL ||  selectedFile.getCornerPointsChanged()) {
            cpChanged = "1";
        }

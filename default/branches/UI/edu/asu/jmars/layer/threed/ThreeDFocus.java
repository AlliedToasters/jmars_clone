...
public class ThreeDFocus extends FocusPanel {
	...
	private int row;
	private Font descripFont = ThemeFont.getRegular();
	...
	private AbstractAction updateAct = new AbstractAction("Update Scene".toUpperCase()) {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction resetCameraAct = new AbstractAction("Reset Camera".toUpperCase()) {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction sourceAct = new AbstractAction("Set Vertical Source...".toUpperCase()) {
		public void actionPerformed(ActionEvent e) {
			ArrayList<MapSource> sources = NumericMapSourceDialog.getUserSelectedSources(ThreeDFocus.this, false);
			if(sources.size()>0){
				MapSource altitudeSource = sources.get(0);
